      ...
      <section ref={heroRef} id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          <div className="mb-6 hero-title">
            <span className="brutal-tag mb-4">NEO-BRUTALIST ENGINEER</span>
          </div>
          
          <h1 className="hero-title text-monumental text-[#FFEA00] brutal-glow mb-6">
            <GlitchText text="MARK ANTHONY" />
            <br />
            <span className="text-white"><GlitchText text="TANTONGCO" /></span>
          </h1>
          
          <div className="hero-subtitle text-xl sm:text-2xl text-white/80 max-w-2xl mx-auto mb-8 leading-relaxed h-16">
            <Typewriter
              texts={[
                "Building sentient digital organisms with WebGPU compute.",
                "Raw brutalist energy. Zero corporate polish.",
                "Particles vote, leaders emerge, chaos flows.",
              ]}
              speed={40}
              deleteSpeed={20}
              pauseDuration={3000}
      ...
      <section className="py-24 px-4 bg-black relative overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="w-14 h-14 border-4 border-[#FFEA00] bg-black flex items-center justify-center hover:bg-[#FFEA00] hover:text-black transition-colors group magnetic">
              <Github className="w-6 h-6 text-[#FFEA00] group-hover:text-black" />
            </a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-14 h-14 border-4 border-[#FFEA00] bg-black flex items-center justify-center hover:bg-[#FFEA00] hover:text-black transition-colors group magnetic">
